...
@TeleOp(name="Teleop_With_Relic", group="Teleop")
public class Teleop_With_Relic extends SkeletonOpMode {
    ...
    static final int RELIC_LIFT_MAX = 0;
    static final int RELIC_LIFT_MIN = 0;
    ...
    public void runOpMode() {
        try {
            ...
            while (opModeIsActive()) {
                ...
                //   servos
                //relic Min and Max code.
                if (relicJoint.getCurrentPosition() > RELIC_LIFT_MAX && gamepad2.dpad_up){
                    relicJoint.setPower(0);
                }
                else if (relicJoint.getCurrentPosition() < RELIC_LIFT_MIN && gamepad2.dpad_down) {
                    relicJoint.setPower(0);
                }
                else{
                    if(gamepad2.dpad_up){
                        relicJoint.setPower(1.0);
                    }
                ...
                // GET RELIC GRABBER AND EXTENDER SCRIPTED!!
