...
/**
 * Created by Power Hawks Robotics on 1/13/2017.
 */
...
public class AutoRed1 extends SkeletonOp {
        ...
        try {
            while (opModeIsActive()) {
                if (!autoMoveDone) {
                    ...
                    goForward(0.5, 1300);
                    telemetry.addData("state", "goBackwards");
                    telemetry.update();
                    rotateRight(1, 720);
                    telemetry.addData("state", "rotateRight");
                    telemetry.update();
                    goForward(.25, 1000);
                    telemetry.addData("state", "goForward");
                    telemetry.update();
                    goGrab(0.75, 300);
